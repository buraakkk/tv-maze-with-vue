...
describe("tvshows.module.js", () => {
  const genres = ["Drama", "Action", "Comedy", "Romance", "Horror", "Family"];
  ...
  describe("tvshow mutation", () => {
    ...
    it("FETCH_TV_SHOWS_DETAILS mutation", () => {
          ...
          episodes: [
            {
              id: 11367,
              url:
                "http://www.tvmaze.com/episodes/11367/the-americans-1x01-pilot",
              name: "Pilot",
              season: 1,
              number: 1,
              airdate: "2013-01-30",
      ...
      const seasonsResult = tvshowsDetails._embedded.episodes.reduce(function(
        r,
        a
      ) {
      ...
      TvshowModule.mutations[types.FETCH_TV_SHOWS_DETAILS](
        state,
        tvshowsDetails
      );
