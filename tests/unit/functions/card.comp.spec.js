...
import CardComp from "@/functions/card.comp.vue";
...
describe("card.comp.vue", () => {
  ...
  let tvshow = {
    ...
    image: {
      medium:
        "https://static.tvmaze.com/uploads/images/medium_portrait/244/611819.jpg",
      original:
        "https://static.tvmaze.com/uploads/images/medium_portrait/244/611819.jpg",
    },
    summary:
  ...
  it("it should have a q-card element", () => {
    expect(cardCompWrapper.find("q-card")).toMatchObject({
      selector: "q-card",
    });
  });
